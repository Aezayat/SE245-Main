//Alex Zayat 
//10-10-24
/* Program Prompt: 1. Calculates and displays employee pay for a 40 hour work week.  
...
//Declare Variable
//empCounter = Employee counter / this will count # per employee
...
for (int i = 0; i < numEmployees; i++)
{
    ...
    Console.WriteLine($"\n{name}'s net pay is: ${netPay:F2} after {taxBracket}% tax");
}
...
double averageIncome = totalNetPay / numEmployees;
Console.WriteLine($"\nThe average income of all employees is: ${averageIncome:F2}");
